...
const highlights = [
  {
    title: 'ค้นหาแบบคำร้องได้เร็วขึ้น',
    description:
      'ผู้ใช้สามารถเลือกตามระดับการศึกษาและค้นหาแบบคำร้องที่เกี่ยวข้องได้จากหน้าเดียว ลดเวลาการไล่หาเอกสารจากหลายแหล่ง'
  },
  {
    title: 'ช่วยทำความเข้าใจข้อมูลก่อนกรอก',
    description:
      'ระบบรวบรวมรายละเอียดที่จำเป็นของแบบคำร้องแต่ละรายการ เพื่อช่วยให้ผู้ใช้เห็นภาพรวมของข้อมูลและเอกสารที่ต้องเตรียม'
  },
  {
    title: 'มีผู้ช่วยแนะนำการใช้งาน',
    description:
      'ผู้ใช้สามารถถามคำถามเบื้องต้นเกี่ยวกับการยื่นคำร้องผ่านระบบแชต เพื่อช่วยตัดสินใจว่าควรเริ่มจากแบบคำร้องใด'
  }
];

const workflow = [
  'เลือกประเภทหรือระดับการศึกษาที่ต้องการใช้งาน',
...
const notes = [
  'AI Formcheck เป็นเครื่องมือช่วยค้นหาและเตรียมความพร้อมของข้อมูล ไม่ใช่ช่องทางยื่นคำร้องอย่างเป็นทางการ',
  'คำแนะนำจากระบบมีไว้เพื่อช่วยสรุปและจัดระเบียบข้อมูล ผู้ใช้ควรตรวจสอบกับหน่วยงานหรือข้อกำหนดล่าสุดก่อนใช้งานจริง',
        ...
        <section className="overflow-hidden rounded-[32px] border border-[#E9DCCB] bg-white shadow-[0_20px_60px_rgba(123,84,47,0.08)]">
          <div className="bg-[linear-gradient(135deg,#FFF7EE_0%,#F7E5CF_55%,#F3D1A8_100%)] px-6 py-10 sm:px-10 sm:py-14">
            ...
            <h1 className="mt-3 max-w-3xl text-[32px] font-extrabold leading-tight text-[#6F4722] sm:text-[42px]">
              ระบบช่วยค้นหา ทำความเข้าใจ และเตรียมความพร้อมก่อนใช้งานแบบคำร้อง
            </h1>
            <p className="mt-5 max-w-3xl text-base leading-8 text-[#6B6258] sm:text-lg">
              AI Formcheck ถูกออกแบบมาเพื่อช่วยให้ผู้ใช้งานเข้าถึงข้อมูลเกี่ยวกับแบบคำร้องได้ง่ายขึ้น
              ลดความสับสนระหว่างการค้นหาเอกสาร และช่วยมองเห็นว่าควรเตรียมข้อมูลอะไรบ้างก่อนเริ่มดำเนินการ
            </p>
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-3">
              <div className="rounded-3xl border border-white/70 bg-white/75 p-5 backdrop-blur">
                ...
                <p className="mt-2 text-sm leading-7 text-[#5F5346]">
                  ช่วยให้ผู้ใช้เข้าถึงข้อมูลแบบคำร้องได้เร็วขึ้นและเข้าใจกระบวนการเบื้องต้นก่อนใช้งานจริง
                </p>
              </div>
              <div className="rounded-3xl border border-white/70 bg-white/75 p-5 backdrop-blur">
              ...
              <div className="rounded-3xl border border-white/70 bg-white/75 p-5 backdrop-blur">
                ...
                <p className="mt-2 text-sm leading-7 text-[#5F5346]">
                  ผู้ใช้ควรตรวจสอบรายละเอียดกับข้อกำหนดล่าสุดของหน่วยงานก่อนนำข้อมูลไปใช้ทุกครั้ง
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr]">
              <div>
                ...
                <h2 className="mt-3 text-[28px] font-extrabold text-[#7B542F]">
                  อธิบายงานเอกสารให้เข้าใจง่ายขึ้นในจุดที่ผู้ใช้มักติดขัด
                </h2>
                <p className="mt-4 text-[15px] leading-8 text-[#5F5346]">
                  หลายครั้งผู้ใช้ไม่ได้ติดปัญหาที่การกรอกเอกสารเพียงอย่างเดียว แต่เริ่มตั้งแต่ไม่แน่ใจว่าต้องใช้แบบคำร้องใด
                  ต้องเตรียมอะไรบ้าง หรือควรเริ่มต้นจากตรงไหน AI Formcheck จึงถูกสร้างขึ้นมาเพื่อช่วยลดภาระในขั้นตอนเหล่านี้
                ...
                <p className="mt-4 text-[15px] leading-8 text-[#5F5346]">
                  ...
                  เพื่อให้ผู้ใช้สามารถสำรวจตัวเลือก ทำความเข้าใจขั้นตอน และเตรียมข้อมูลได้อย่างมั่นใจก่อนดำเนินการจริง
                </p>
              </div>
