...
ใน runtime ปัจจุบัน backend ยังรองรับ OIDC flow เดิม และจะ:
...
- backend รองรับ trusted BFF auth แบบ opt-in
- frontend/BFF ต้องส่ง shared secret + forwarded user identity headers
- รายละเอียด header contract ดูที่ [BFF_BACKEND_CONTRACT.md](/Users/pst./senior/backend/BFF_BACKEND_CONTRACT.md)
