...
raw intake object ที่ต้องค้างรอ worker จะถูกเข้ารหัสระดับแอปก่อนเก็บลง GCS และถูกลบทิ้งหลัง worker ทำงานจบหรือ fail เพื่อลด exposure window ของไฟล์ระหว่างทาง
